...
def get_message(birth_path_num)
	...
	when  1
		message = "Your numerology number is 1. One is the leader. The number one indicates the ability to stand alone, 
	...
	when  3
		message = "Number Three is a sociable, friendly, and outgoing vibration. Kind, positive, and optimistic, 
		Three is enjoy life and have a good sense of humor. Ruled by Jupiter."
	when  4
	...
	when  5
		message = "This is the freedom lover. The number five is an intellectual vibration. These are idea people with a love of variety and the ability 
	...
	when  9
		...
		message = "Your birth path number is not in between in 1-9"
	end
end

puts "What is your birth Date? (MMDDYY)"
birthDate = gets
